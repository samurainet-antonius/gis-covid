<?php
$detail = $desa->detail($_GET['id']);
?>
<!-- Page Heading -->
<div class="clearfix">
	<h1 class="h3 mb-4 float-left text-gray-800">Edit Desa</h1>
...
<div class="card">
	<div class="card-body">
		<form method="POST">
			<div class="form-group">
				...
				<select name="provinsi" class="form-control" required>
					<option value="<?php echo $detail['provinsi'] ?>" selected><?php echo $detail['provinsi'] ?></option>
				</select>
			</div>
			<div class="form-group">
		...
		if(isset($_POST['simpan'])){
			$cek = $desa->edit($_POST['provinsi'],$_POST['kabupaten'],$_POST['kecamatan'],$_POST['nama_desa']);
